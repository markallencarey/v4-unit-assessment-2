...
//CODE HERE
  let phone1 = new Phone('Apple', 'iPhone X', 32, 'Space Grey', false)
  
  let phone2 = new Phone('Android', 'Pixel 2', 64, 'White', false)
  
  let phone3 = new Phone('Apple', 'iPhone 12', 128, 'Sky Blue', false)
